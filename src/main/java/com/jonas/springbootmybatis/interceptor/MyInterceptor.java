package com.jonas.springbootmybatis.interceptor;
...
public class MyInterceptor {
    ...
    @Pointcut("within (com.jonas.springbootmybatis.controller..*) && !within(com.jonas.springbootmybatis.controller.admin.LoginController)")
